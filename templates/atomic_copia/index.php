...
<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/<?php echo $this->template ?>/css/menu_style.css" type="text/css" media="screen, projection" />
...
<div class="header"><!-- end .header -->
    ...
    <div class="busqueda">
<jdoc:include type="modules" name="busqueda" style="none" />
